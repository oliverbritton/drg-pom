...
extern Memb_func* memb_func;
 ...
 "setdata_Shh_6", _hoc_setdata,
 "rates_Shh_6", _hoc_rates,
 "vtrap_Shh_6", _hoc_vtrap,
 0, 0
};
#define vtrap vtrap_Shh_6
 extern double vtrap( double , double );
 /* declare global and static user variables */
#define htau htau_Shh_6
 double htau = 0;
#define hinf hinf_Shh_6
 double hinf = 0;
#define mtau mtau_Shh_6
 double mtau = 0;
#define minf minf_Shh_6
 double minf = 0;
#define ntau ntau_Shh_6
 double ntau = 0;
#define ninf ninf_Shh_6
 double ninf = 0;
#define usetable usetable_Shh_6
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gl_Shh_6", 0, 1e+09,
 "gkbar_Shh_6", 0, 1e+09,
 "gnabar_Shh_6", 0, 1e+09,
 "usetable_Shh_6", 0, 1,
 0,0,0
};
 ...
 "minf_Shh_6", &minf_Shh_6,
 "hinf_Shh_6", &hinf_Shh_6,
 "ninf_Shh_6", &ninf_Shh_6,
 "mtau_Shh_6", &mtau_Shh_6,
 "htau_Shh_6", &htau_Shh_6,
 "ntau_Shh_6", &ntau_Shh_6,
 "usetable_Shh_6", &usetable_Shh_6,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 7);
 	...
 	ivoc_help("help ?1 Shh_6 /cygdrive/e/CLPC48/Neuroscience Project/Code/Models/Kovalsky/DRG_Devor/shift_hh_6.mod\n");
...
static int _reset;
static char *modelname = "shift_hh_6.mod  ";
...
static int  _f_rates (  double _lv ) {
  ...
  _zq10 = pow( 3.0 , ( ( celsius - 6.3 ) / 10.0 ) ) ;
   _lalpha = .1 * vtrap ( _threadargscomma_ - ( _lv + 34.0 ) , 10.0 ) ;
   _lbeta = 4.0 * exp ( - ( _lv + 59.0 ) / 18.0 ) ;
   _lsum = _lalpha + _lbeta ;
   mtau = 1.0 / ( _zq10 * _lsum ) ;
   minf = _lalpha / _lsum ;
   _lalpha = .07 * exp ( - ( _lv + 59.0 ) / 20.0 ) ;
   _lbeta = 1.0 / ( exp ( - ( _lv + 29.0 ) / 10.0 ) + 1.0 ) ;
   _lsum = _lalpha + _lbeta ;
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 55 in file shift_hh_6.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
