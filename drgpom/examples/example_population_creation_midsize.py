...
if __name__ == '__main__':
    ...
    pop_name = 'example_population_midsize'
    pop_save_filename = '{}.pkl'.format(pop_name)
    ...
    if parameter_data is not None:
        ...
        parameter_set_details['output_filename'] = 'example_population_midsize_creating_parameters.csv'   
    else:
