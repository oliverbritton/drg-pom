...
#define nrn_init _nrn_init__nav17vw
#define _nrn_initial _nrn_initial__nav17vw
#define nrn_cur _nrn_cur__nav17vw
#define _nrn_current _nrn_current__nav17vw
#define nrn_jacob _nrn_jacob__nav17vw
#define nrn_state _nrn_state__nav17vw
#define _net_receive _net_receive__nav17vw 
#define _f_rates _f_rates__nav17vw 
#define rates rates__nav17vw 
#define states states__nav17vw 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nav17vw", _hoc_setdata,
 "rates_nav17vw", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define htau htau_nav17vw
 double htau = 0;
#define hinf hinf_nav17vw
 double hinf = 0;
#define mtau mtau_nav17vw
 double mtau = 0;
#define minf minf_nav17vw
 double minf = 0;
#define usetable usetable_nav17vw
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gbar_nav17vw", 0, 1e+009,
 "usetable_nav17vw", 0, 1,
 0,0,0
};
 ...
 "minf_nav17vw", &minf_nav17vw,
 "hinf_nav17vw", &hinf_nav17vw,
 "mtau_nav17vw", &mtau_nav17vw,
 "htau_nav17vw", &htau_nav17vw,
 "usetable_nav17vw", &usetable_nav17vw,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav17vw F:/CLPC48/drg-pom/drgpom/models/Nav17vw.mod\n");
...
static int _reset;
static char *modelname = "Nav 1.7 from Vasylyev, Waxman et al. 2014";
...
static int  _f_rates (  double _lv ) {
  ...
  _lalpha_m = 10.22 - 10.22 / ( 1.0 + exp ( ( _lv + 7.19 ) / 15.43 ) ) ;
   _lbeta_m = 23.76 / ( 1.0 + exp ( ( _lv + 70.37 ) / 14.53 ) ) ;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 45 in file Nav17vw.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Nav17vw.mod";
static const char* nmodl_file_text = 
