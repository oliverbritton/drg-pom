...
#define nrn_init _nrn_init__nav17cw
#define _nrn_initial _nrn_initial__nav17cw
#define nrn_cur _nrn_cur__nav17cw
#define _nrn_current _nrn_current__nav17cw
#define nrn_jacob _nrn_jacob__nav17cw
#define nrn_state _nrn_state__nav17cw
#define _net_receive _net_receive__nav17cw 
#define _f_rates _f_rates__nav17cw 
#define rates rates__nav17cw 
#define states states__nav17cw 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nav17cw", _hoc_setdata,
 "rates_nav17cw", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define htau htau_nav17cw
 double htau = 0;
#define hinf hinf_nav17cw
 double hinf = 0;
#define mtau mtau_nav17cw
 double mtau = 0;
#define minf minf_nav17cw
 double minf = 0;
#define stau stau_nav17cw
 double stau = 0;
#define sinf sinf_nav17cw
 double sinf = 0;
#define usetable usetable_nav17cw
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gbar_nav17cw", 0, 1e+009,
 "usetable_nav17cw", 0, 1,
 0,0,0
};
 ...
 "minf_nav17cw", &minf_nav17cw,
 "hinf_nav17cw", &hinf_nav17cw,
 "sinf_nav17cw", &sinf_nav17cw,
 "mtau_nav17cw", &mtau_nav17cw,
 "htau_nav17cw", &htau_nav17cw,
 "stau_nav17cw", &stau_nav17cw,
 "usetable_nav17cw", &usetable_nav17cw,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav17cw F:/CLPC48/drg-pom/drgpom/models/Nav17cw.mod\n");
...
static int _reset;
static char *modelname = "Nav 1.7 from Choi/Waxman";
...
static int  _f_rates (  double _lv ) {
  ...
  _lalpha_m = 15.5 / ( 1.0 + exp ( - ( _lv - 5.0 ) / ( 12.08 ) ) ) ;
   _lbeta_m = 35.2 / ( 1.0 + exp ( ( _lv + 72.7 ) / 16.7 ) ) ;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 45 in file Nav17cw.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Nav17cw.mod";
static const char* nmodl_file_text = 
