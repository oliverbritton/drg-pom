...
#define nrn_init _nrn_init__nav18hw
#define _nrn_initial _nrn_initial__nav18hw
#define nrn_cur _nrn_cur__nav18hw
#define _nrn_current _nrn_current__nav18hw
#define nrn_jacob _nrn_jacob__nav18hw
#define nrn_state _nrn_state__nav18hw
#define _net_receive _net_receive__nav18hw 
#define _f_rates _f_rates__nav18hw 
#define rates rates__nav18hw 
#define states states__nav18hw 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_nav18hw", _hoc_setdata,
 "rates_nav18hw", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define htau htau_nav18hw
 double htau = 0;
#define hinf hinf_nav18hw
 double hinf = 0;
#define mtau mtau_nav18hw
 double mtau = 0;
#define minf minf_nav18hw
 double minf = 0;
#define usetable usetable_nav18hw
 double usetable = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "gbar_nav18hw", 0, 1e+009,
 "usetable_nav18hw", 0, 1,
 0,0,0
};
 ...
 "minf_nav18hw", &minf_nav18hw,
 "hinf_nav18hw", &hinf_nav18hw,
 "mtau_nav18hw", &mtau_nav18hw,
 "htau_nav18hw", &htau_nav18hw,
 "usetable_nav18hw", &usetable_nav18hw,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav18hw F:/CLPC48/drg-pom/drgpom/models/Nav18hw.mod\n");
...
static int _reset;
static char *modelname = "Human Nav 1.8 from Han/Waxman et al.";
...
static int  _f_rates (  double _lv ) {
  ...
  _lalpha_m = 7.35 - 7.35 / ( 1.0 + exp ( ( _lv + 1.38 ) / 10.9 ) ) ;
   _lbeta_m = 5.97 / ( 1.0 + exp ( ( _lv + 56.43 ) / 18.26 ) ) ;
   minf = _lalpha_m / ( _lalpha_m + _lbeta_m ) ;
   mtau = 1.0 / ( _lalpha_m + _lbeta_m ) ;
   _lalpha_h = 0.011 + 1.39 / ( 1.0 + exp ( ( _lv + 78.04 ) / 11.32 ) ) ;
   _lbeta_h = 0.56 - 0.56 / ( 1.0 + exp ( ( _lv - 21.82 ) / 20.03 ) ) ;
 ...
 v=_v;
{
  ena = _ion_ena;
 { error =  states();
 if(error){fprintf(stderr,"at line 49 in file Nav18hw.mod:\n        SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "Nav18hw.mod";
static const char* nmodl_file_text = 
