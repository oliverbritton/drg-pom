...
#define nrn_init _nrn_init__nav18tf
#define _nrn_initial _nrn_initial__nav18tf
#define nrn_cur _nrn_cur__nav18tf
#define _nrn_current _nrn_current__nav18tf
#define nrn_jacob _nrn_jacob__nav18tf
#define nrn_state _nrn_state__nav18tf
#define _net_receive _net_receive__nav18tf 
#define _f_rates _f_rates__nav18tf 
#define rates rates__nav18tf 
#define states states__nav18tf 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 nav18tf F:/CLPC48/drg-pom/drgpom/models/Nav18tf.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "Nav18tf.mod";
static const char* nmodl_file_text = 
